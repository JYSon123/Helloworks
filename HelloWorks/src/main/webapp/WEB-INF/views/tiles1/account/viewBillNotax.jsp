...
<script type="text/javascript">
	...
	function goSubmit() {
		...
		frm.action = "<%=request.getContextPath()%>/account/updateBillNoTax.hello2";
		frm.method = "POST";		
		frm.submit();
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom: 300px;">
    ...
    <div class="container" style="margin-top: 70px;">
		...
		<form id="submitFrm" name="submitFrm" method="POST">
			<input type="hidden" name="seq" value="${doc.billnotax_seq}"/>
			<input type="hidden" name="state"/>
			<input type="hidden" name="tabName2" value="tbl_billnotax"/>
			<input type="hidden" name="loc" value="<%=ctxPath%>/account/viewBill.hello2?tabName=tbl_billnotax&seq=${doc.billnotax_seq}"/>
 		</form>
   		...
   		<form style="width: 100%; font-size: 10pt; border: solid 1px red; padding: 1px;" name="billFrm">
			...
			<table class="mytbl">
				...
				<tr>
					...
					<td colspan="3">${doc.billnotax_seq}<input type="hidden" name="billnotax_seq" value="${doc.billnotax_seq}"></td>
				</tr>
			...
			<table class="mytbl">
				...
				<tr>
					<td style="width: 30%;"><input type="text" id="total" value="${doc.totalprice}" disabled readonly class="form-control"/></td>
			     ...
			     <!-- Modal body -->
			      <div class="modal-body text-center">
				      	...
				      	<form name="deleteFrm" method="POST" action="<%=ctxPath%>/account/deleteDoc.hello2">
				      		<input type="hidden" value="${doc.billnotax_seq}" name="seqes" required>
				      		<input type="hidden" value="tbl_billnotax" name="tabName3">				      		
