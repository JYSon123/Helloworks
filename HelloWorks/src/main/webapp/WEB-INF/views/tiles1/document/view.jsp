...
<div style="margin: auto; padding-left: 3%;">
	...
	<%-- <c:if test="${not empty requestScope.boardvo}"> --%>
		<table style="width: 1024px;" class="table" >
			...
			<c:if test="${documentvo.result == 0 }">
				<tr> 	
					<th style="border-right: none; vertical-align: middle"  >결재하기</th>
					<td style="vertical-align: middle" colspan="2">
						<select name="change" id="change" style="width: 12%; height: 30px;">
					     	<option value="1">승인</option>
					     	<option value="2">반려</option>
					     </select>
					     <button onclick="result()" type="button" class="btn btn-sm mr-3 ml-1 mb-1" style="background-color: #0070C0; color: white;" >변경</button>
