	...
	<%-- <c:if test="${not empty requestScope.boardvo}"> --%>
		<table style="width: 1024px" class="table table-bordered" >
			...
			<tr>	
				...
				<td colspan="2">
						<a href="<%= request.getContextPath()%>/download.action?seq=${requestScope.documentvo.doument_seq}">${requestScope.documentvo.orgFilename}</a>
				</td>
			</tr>
			<tr>	
			...
			<c:if test="${sessionScope.loginEmp.empno == 202111081004 && documentvo.result == 0}">
				<tr> 	
					...
					<td style="vertical-align: middle">
						...
						<button type="button" class="btn btn-info btn-sm mr-3 ml-1 mb-1" onclick="javascript:location.href='<%= request.getContextPath()%>/add.action?fk_seq=${requestScope.boardvo.seq}&groupno=${requestScope.boardvo.groupno}&depthno=${requestScope.boardvo.depthno}&subject=${requestScope.boardvo.subject}'">변경</button>
					</td>
				</tr>
