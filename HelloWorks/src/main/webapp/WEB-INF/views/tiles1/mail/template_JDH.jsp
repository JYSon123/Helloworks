...
<nav class="w3-sidebar w3-collapse w3-white " style="margin-top:20px; z-index:0; width:300px; background-color:#f5f5f5; overflow: auto;" id="mySidebar"><br>
  <div class="w3-container" style="background-color:#f5f5f5; margin-top:10px" >
	...
	<br><br>
    <span style="font-size:20pt; margin:100px 0 30px 40px ; color:gray"><b>사내 메일</b></span>
  </div>
  
  <div class="w3-bar-block" style="background-color:#f5f5f5; height: 100%">
	<div style="margin-left:42px; font-size: 13pt">
	  <br>
	  <a href="<%=ctxPath %>/mailList.hello2" class="w3-bar-item w3-button">받은 메일함</a>
	  <a href="<%=ctxPath %>/sendmailList.hello2" class="w3-bar-item w3-button">보낸 메일함</a>
	  <a href="<%=ctxPath %>/send.hello2" class="w3-bar-item w3-button">메일 보내기</a>
	  <a href="<%=ctxPath %>/trashmailList.hello2" class="w3-bar-item w3-button">휴지통</a>
  	</div>
  </div>  
</nav>
<!-- 좌측 고정 상세메뉴 끝 -->
