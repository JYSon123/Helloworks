...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		// 보낸메일 선택삭제
		$("button#deleteSendMail").click(function(){
			...
			frm.method = "POST";
			frm.action = "deleteSendMail.hello2";
			frm.submit();
...
<div class="w3-main" style="margin:30px 0 0 300px" >
  ...
  <div class="w3-container w3-padding-large" style="margin-bottom: 300px;">
	...
	<h2 style="margin-bottom: 30px;">보낸메일목록</h2>
	
	<div style="width: 100%;">
		<button type="button" class="btn btn-secondary btn-sm" id="deleteSendMail" style="float: left;">삭제</button>
	...
	<table style="width: 900px;" class="table table-bordered">
		...
		<tr>
			...
			<th style="width: 10%; text-align: center;">수신ID</th>
		...
		<tbody>
		<c:forEach var="mailvo" items="${requestScope.sendmailList}">
			<tr>
				<td style="width: 30px;">
					<input type="checkbox" name="check" id="statusEach" value="${mailvo.mailseq}"/>
				</td>
				<td align="center">${mailvo.recid}</td>
				<td align="center">${mailvo.recname}</td>
